Feature: metadata checks are reported in a prometheus compatible metrics endpoint
  ...
  Scenario: Check healthy metadata
    ...
    verify_federation_certificate_expiry{entity_id="metadata_signature",key_use="",key_name="certificate",serial="2",cn="SIGNED TEST CERTIFICATE"} (\d+).0
    ...
    verify_federation_certificate_ocsp_success{entity_id="metadata_signature",key_use="",key_name="certificate",serial="2",cn="SIGNED TEST CERTIFICATE"} 1.0
    """
